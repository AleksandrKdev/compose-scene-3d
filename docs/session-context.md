...
Continue mobile interactive-textbook support with radial/angular dimensions and reusable Compose
label anchoring on Android/iOS.
...
procedural hatch cap materials, and linear engineering dimension geometry are done.
