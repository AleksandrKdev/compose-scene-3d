...
Continue mobile interactive-textbook support with procedural section hatch fills on Android/iOS.
...
plane section views and CPU-generated concave/multi-contour/holed section caps for custom meshes are
done.
