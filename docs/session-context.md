...
Continue mobile interactive-textbook support with reusable dimension lines and engineering
annotations on Android/iOS.
...
procedural hatch cap materials are done.
