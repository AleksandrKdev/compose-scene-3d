...
Continue mobile interactive-textbook support with per-part material overrides and highlighting on
Android/iOS. Imported hierarchy, individual part picking, subtree visibility and local transform
offsets are done.
