...
Continue mobile interactive-textbook support with robust multi-contour section caps and procedural
hatch fills on Android/iOS.
...
plane section views and convex CPU-generated section caps for custom meshes are done.
